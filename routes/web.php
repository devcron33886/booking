...
Route::get('/failed','ErrorController@failed')->name('failed');
Route::get('/cancelled','ErrorController@cancelled')->name('cancelled');
Route::get('/success','ErrorController@success')->name('success');
